 ...
 * 따로 박혀 있었기 때문이다. 요구사항·시험항목·플랜이 저마다 제 팔레트를
...
export const DEFAULT_BG: Record<string, string> = {
  ...
  /* 자동·수동은 팀이 이름을 바꿔 쓴다(253 은 M·A) — 아는 별명은 같은 색으로.
     뜻을 푸는 규칙은 lib/runMode 에 있고, 여기는 그 값들의 **색**이다. */
  자동: '#00c875', A: '#00c875', AUTO: '#00c875', Auto: '#00c875',
  수동: '#7f5347', M: '#7f5347', MANUAL: '#7f5347', Manual: '#7f5347',
  혼합: '#fdab3d',
  자체: '#037f4c', 고객: '#0086c0',
  /* 플랜 상태 */
