 ...
 * 전역 파라미터.
 *
 * 중괄호 한 쌍. 스텝에 적는 모양이 `${이름}` 이라 사람 눈이 이미 그
 * 괄호를 「값이 들어올 자리」 로 읽는다. 톱니바퀴나 문서 아이콘으로는
 * 설정인지 파일인지 갈리지 않는다.
 */
export const IconParam = (p: P) => (
  <Svg {...p}>
    <path d="M9 4c-1.7 0-1.7 2.7-1.7 4S7.3 10 5.6 12c1.7 2 1.7 2.7 1.7 4s0 4 1.7 4" />
    <path d="M15 4c1.7 0 1.7 2.7 1.7 4s0 2 1.7 4c-1.7 2-1.7 2.7-1.7 4s0 4-1.7 4" />
    <path d="M12 12h.01" />
  </Svg>
)
